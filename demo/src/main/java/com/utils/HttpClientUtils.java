...
import com.utils.core.HttpRequestMethod;
import com.utils.core.HttpRequestResult;
import com.utils.core.MyHttpClientBuilder;
...
public class HttpClientUtils {
			...
			if (httpRequestConfig.isUseSSL()) {
				if (httpsClient == null) {
					synchronized (syncLock) {
						if (httpsClient == null) {
							httpsClient = MyHttpClientBuilder.custom().ssl()
									.timeout(CONNECT_TIMEOUT, SOCKET_TIMEOUT, CONNECT_REQUEST_TIMEOUT)
									.pool(MAX_TOTAL, MAX_PER_ROUTE).retry(RETRY_TIMES, false).build();
	...
	public static HttpRequestResult get(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.GET)),
				httpRequestConfig);
	}
	...
	public static HttpRequestResult post(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.POST)),
				httpRequestConfig);
	}
	...
	public static HttpRequestResult put(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.PUT)),
				httpRequestConfig);
	}
	...
	public static HttpRequestResult header(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.HEAD)),
				httpRequestConfig);
	}
	...
	public static HttpRequestResult patch(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.PATCH)),
				httpRequestConfig);
	}
	...
	public static HttpRequestResult delete(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.DELETE)),
				httpRequestConfig);
	}
	...
	public static HttpRequestResult trace(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.TRACE)),
				httpRequestConfig);
	}
	...
	public static HttpRequestResult options(HttpRequestConfig httpRequestConfig) throws IOException {
		return transformHttpRequestResult(execute(httpRequestConfig.requestMethod(HttpRequestMethod.OPTIONS)),
				httpRequestConfig);
	}
	...
	private static HttpRequestResult transformHttpRequestResult(HttpResponse response, HttpRequestConfig config)
			throws IOException {
		// 获取结果实体
		HttpRequestResult result = new HttpRequestResult(response.getStatusLine().getStatusCode(),
				response.getAllHeaders());
		if (response.getEntity() != null) {
			// content 编码
			String charset = (response.getEntity().getContentEncoding() == null) ? config.getResponseCharset()
